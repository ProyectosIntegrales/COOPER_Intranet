...
Partial Class cdd_users
    ...
    Public Sub Update(sender As Object, e As ImageClickEventArgs)
        ...
        doSQLProcedure("cdd.spUsers", Data.CommandType.StoredProcedure, _
                       "@action", "UPD",
                       "@userID", uid, _
                       "@privLevel", DirectCast(gvr.FindControl("ddlPrivLevel"), DropDownList).SelectedValue)
    ...
    Public Sub Insert(sender As Object, e As ImageClickEventArgs)
        ...
        doSQLProcedure("cdd.spUsers", Data.CommandType.StoredProcedure, _
                "@action", "ADD",
                "@userID", UID, _
                "@privLevel", DirectCast(gvf.FindControl("ddlPrivLevel"), DropDownList).SelectedValue)
    ...
    Public Sub Delete(sender As Object, e As ImageClickEventArgs)
        doSQLProcedure("cdd.spUsers", Data.CommandType.StoredProcedure, "@action", "DEL", "@userId", DirectCast(sender, ImageButton).CommandArgument)
        GridView1.DataBind()
    End Sub
