<%@ Control Language="VB" AutoEventWireup="false" CodeFile="cddDocTypes.ascx.vb" Inherits="cdd_cddDocTypes" %>
<style type="text/css">
...
a
{
    ...
    CellPadding="4" DataKeyNames="typeId" DataSourceID="dsDocTypes" 
    ForeColor="#333333" GridLines="None" CssClass="gridview" 
    AllowPaging="True" AllowSorting="True" Width="100%">
    <AlternatingRowStyle BackColor="White" />
    <Columns>
        <asp:BoundField DataField="typeId" HeaderText="Tipo No." InsertVisible="False" 
        ...
        <asp:TemplateField HeaderText="Tipo de Documento" SortExpression="typeNameEsp" 
            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
            <EditItemTemplate>
                <asp:TextBox ID="txtTypeNameEsp" runat="server" Text='<%# Bind("typeNameEsp") %>' Width="100%" cssclass="textbox" Font-Size="9"></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="Label1" runat="server" Text='<%# Bind("typeNameEsp") %>'></asp:Label>
            </ItemTemplate>
               <FooterTemplate>
                <asp:TextBox ID="txtTypeNameEsp" runat="server" Text="" Width="100%" 
...
<ItemStyle HorizontalAlign="Left" Font-Bold="True"></ItemStyle>
        ...
        <asp:TemplateField HeaderText="Aprobación por<br>Gerente" SortExpression="mgrApproval">
            <EditItemTemplate>
                <asp:checkBox ID="chkreqApproval" runat="server" Checked='<%# isnull(Eval("mgrApproval"),0) %>'></asp:checkBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:checkBox ID="chkreqApproval" runat="server" Checked='<%# isnull(Eval("mgrApproval"),0) %>' Enabled="false"></asp:checkBox>
            </ItemTemplate>
            <FooterTemplate>
            <asp:checkBox ID="chkreqApproval" runat="server" Checked="false"></asp:checkBox>
            </FooterTemplate>
...
<asp:SqlDataSource ID="dsDocTypes" runat="server" 
    ...
    SelectCommand="SELECT * FROM cdd.tblDocTypes"></asp:SqlDataSource>
