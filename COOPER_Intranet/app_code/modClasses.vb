...
Public Class User
    ...
    Private Sub getUserInfo(User_name As String)
        ...
        Dim dtUser As DataTable = SQLDataTable("Select * from vUsers where Username = '" & User_name & "'")
...
Public Class Employee
    ...
    Private Sub getUserInfo(EmployeeNo As Object)
        ...
        Try
            ...
            Dim dtUser As DataTable = SQLDataTable("Select * from vUsers where userEmployeeNo = " & empNo)
            If dtUser.Rows.Count > 0 Then
                Dim dr As DataRow = dtUser.Rows(0)
                _username = dr.Item("userName").ToString.Trim.ToLower
                _firstname = isNull(dr.Item("userFirstName"), "[No Name]").ToString.Trim
...
Public Class Depto
    ...
    Protected Sub getDeptInfo(dId As Integer)
        Dim dt As DataTable = SQLDataTable("select * from vDeptos where deptoId = " & dId)
